(() => {
	...
	function setCanvasImages() {
		let imgElem;
		for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) { //change 6726 to 0 ...
			imgElem = new Image();
			imgElem.src = `./video/001/IMG_${0 + i}.jpg`;
			sceneInfo[0].objs.videoImages.push(imgElem);
		}

		let imgElem2;
		for (let i = 0; i < sceneInfo[2].values.videoImageCount/*changed*/; i++) {
			imgElem2 = new Image();
			imgElem2.src = `./video/002/IMG_${0 + i}.JPG`;
